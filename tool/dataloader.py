...
import os.path
from torch.tool.data import Dataset
import torch
...
def collate_fn(batch):
    ...
    return torch.tool.data.dataloader.default_collate(batch)
...
if __name__ == "__main__":
    from torch.tool.data import DataLoader
    category = "table"
    ViPCDataset = dataloder('test_list2.txt',data_path='/home/aiello/ShapeNetViPC-Dataset',status='test', category = category)
